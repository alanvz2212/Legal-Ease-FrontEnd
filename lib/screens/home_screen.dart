            ...
            builder: (context, snapshot) {
              ...
              if (user == null) {
                return const SizedBox
                    .shrink(); // Return nothing if user data is not available
              }
      ...
      drawer: Drawer(
        child: ListView(
          ...
          children: [
              ...
              builder: (context, snapshot) {
                ...
                if (user == null) {
                  return DrawerHeader(
                    child: Center(
                        child: Text(
                      'Legal Ease', style: GoogleFonts.lobster(fontSize: 30),
                      // style: TextStyle(
            ...
            //     MaterialPageRoute(
            //         builder: (context) =>
            //             const CommunityScreen()), // Navigate to the Community screen
            //   );
            // },
            // ),
            ...
            ListTile(
              ...
              onTap: () async {
                ...
                Navigator.pushReplacement(
                  ...
                  MaterialPageRoute(
                      builder: (context) =>
                          const SignInScreen()), // Navigate to sign-in screen
                );
              },
            ),
          ],
