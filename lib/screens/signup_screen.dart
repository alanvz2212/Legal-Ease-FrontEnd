  ...
  Future<void> _signUpWithGoogle() async {
    try {
      ...
      final GoogleSignIn googleSignIn = GoogleSignIn(
        ...
        clientId:
            '741437834313-3nrv5rid6t5iesclck72o1v52i18o0cp.apps.googleusercontent.com', // Replace with actual Web Client ID
      );
      ...
      if (response.session != null) {
        ...
        _showCustomSnackBar(
            'Google Sign-In Error: Please try again.', Colors.red);
      }
    } catch (e) {
  ...
  Future<void> _signUpWithGitHub() async {
    try {
      ...
      if (response != null) {
        ...
        _showCustomSnackBar(
            'GitHub Sign-Up failed. Please try again.', Colors.red);
      }
    } catch (e) {
    ...
    if (_formSignupKey.currentState!.validate() && agreePersonalData) {
      try {
        ...
        if (response.user != null) {
          ...
          _showCustomSnackBar(
              'Confirmation mail has been sent to your inbox', Colors.green);
          Navigator.pushReplacement(
            context,
          ...
          _showDialog(
              'Sign-Up Error', 'User could not be created. Please try again.');
        }
      } catch (e) {
      ...
      _showDialog('Agreement Required',
  ...
  void _showCustomSnackBar(String message, Color color) {
    final snackBar = SnackBar(
      ...
      margin: const EdgeInsets.all(
          10.0), // Add margin to separate it from the screen edges
      duration:
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          onPressed:
                              _signUpWithEmail, // Trigger sign-up function
