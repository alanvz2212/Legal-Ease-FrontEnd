  ...
  Future<void> _signInWithGitHub() async {
    try {
      ...
      if (response != null) {
        ...
        _showCustomSnackBar(
            'GitHub Sign-In Error: Please try again.', Colors.red);
      }
    } catch (e) {
  ...
  Future<void> _signInWithGoogle() async {
    try {
      ...
      final GoogleSignIn googleSignIn = GoogleSignIn(
        ...
        clientId:
            '357056543259-v8rccm2k39kc53r35msslfjgitjji53d.apps.googleusercontent.com', // Replace with actual Web Client ID
      );
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextFormField(
                        controller:
                            _emailController, // Added controller for email
                        validator: (value) {
